...
main = text(
    "pythTriplesMapTest:" ++ String.concat pythTriplesMapTest ++ 
    "pythTriplesRecTest:" ++ String.concat pythTriplesRecTest ++
    "arePythTriplesFilterTest:" ++ String.concat arePythTriplesFilterTest ++ 
    "arePythTriplesRecTest:" ++ String.concat arePythTriplesRecTest)
